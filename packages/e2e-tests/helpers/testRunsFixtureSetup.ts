...
export const testRunStates = {
  ...
  UNIQUE_TESTS_FOR_TESTS_VIEW: {
    ...
    tests: [
      ...
      {
        testId: "unq-seventh-test-id",
        runnerGroupId: "unq-first-runner-group-id",
        index: 0,
        attempt: 0,
        scope: [],
