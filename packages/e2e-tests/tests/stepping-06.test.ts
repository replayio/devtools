...
test(`stepping-06: Test stepping in async frames and async call stacks`, async ({
  ...
  // HACK The frame percentages below seem fickle and recording-specific.
  // They will likely require adjusting if we re-record "doc_async.html"
  ...
  await stepOverToLine(page, 22); // TODO [FE-2109][RUN-2958] Chromium steps to the same line again
