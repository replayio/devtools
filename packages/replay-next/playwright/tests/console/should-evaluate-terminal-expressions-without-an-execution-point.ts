...
test("should evaluate terminal expressions without an execution point", async ({
  page,
}, testInfo) => {
  await setup(page);
  ...
  await takeScreenshot(page, testInfo, newListItem, "global-terminal-expression-valid");
});
