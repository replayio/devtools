...
test("should properly toggle breakable and loggable behaviors when there are multiple breakable positions on a line", async ({
  ...
  await takeScreenshot(page, testInfo, lineLocator, "line-4-column-19-should-log");

  await addBreakPoint(page, { lineNumber, sourceId });
  await stopHovering(page);
  await takeScreenshot(page, testInfo, lineLocator, "line-4-column-19-should-log-and-break");
  ...
  await takeScreenshot(
    ...
    testInfo,
    lineLocator,
    "line-4-column-19-should-log-and-22-should-break"
  );
  ...
  await stopHovering(page);
  await takeScreenshot(page, testInfo, lineLocator, "line-4-column-22-should-break");
});
