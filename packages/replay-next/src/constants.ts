...
export type EventCategory = {
  ...
  events: Array<{
    /**
     * Unique name, recognized by the runtime.
     */
...
export const STANDARD_EVENT_CATEGORIES: Partial<Record<RecordingTarget, EventCategory[]>> = {
  ...
  chromium: makeChromiumCategories()
};


export type EventCategoriesByEvent = Record<string, string>;
export type EventCategoriesByEventAndTarget = Record<string, Record<string, string>>;

// <GENERATED CODE. DO NOT EDIT>
export const ChromiumEventCategoriesByEventDefault: EventCategoriesByEvent = {
  load: 'load',
  click: 'mouse',
  // ... 100+ more entries ...
};
export const ChromiumEventCategoriesByEventAndTarget: EventCategoriesByEventAndTarget = {
  load: {
    xmlhttprequest: 'xhr',
...
function makeChromiumCategories() {
  return [
    // TODO
    {
      category: "Mouse",
    ...
    },
    {
      category: "Load",
      events: [
        { type: "load", uniqueName: "Load.load", label: "load" },
      ]
    },
    {
      category: "Xhr",
      events: [
        { type: "load", label: "load", eventTargets: ["xmlhttprequest", "xmlhttprequestupload"] },
      ]
    }
  ];
}
