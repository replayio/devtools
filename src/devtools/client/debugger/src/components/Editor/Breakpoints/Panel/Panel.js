...
export default function Panel({ breakpoint, editor, insertAt, hoveredWidgetMarker }) {
  ...
  const focused =
    ...
    breakpoint?.location &&
    getLocationKey(hoveredWidgetMarker.location) == getLocationKey(breakpoint.location);
