...
describe("text", () => {
  it("should truncate the text in the middle", () => {
    ...
    expect(truncateMiddleText(sourceText, 30)).toMatch("this is a ver… and ends here");
  });
  it("should keep the text as it is", () => {
    const sourceText = "this is a short text ends here";
    expect(truncateMiddleText(sourceText, 30)).toMatch("this is a short text ends here");
  });
});
