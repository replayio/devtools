...
function Editor(config) {
  const tabSize = 2; //Services.prefs.getIntPref(TAB_SIZE);
  const useTabs = false; //!Services.prefs.getBoolPref(EXPAND_TAB);
  const useAutoClose = true; //Services.prefs.getBoolPref(AUTO_CLOSE);
