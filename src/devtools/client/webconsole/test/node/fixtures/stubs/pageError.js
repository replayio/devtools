...
rawPackets.set(`SyntaxError: redeclaration of let a`, {
  pageError: {
    ...
    exceptionDocURL:
      "https://developer.mozilla.org/docs/Web/JavaScript/Reference/Errors/Redeclared_parameter?utm_source=mozilla&utm_medium=firefox-console-errors&utm_campaign=default",
    sourceName:
      "http://example.com/browser/devtools/client/webconsole/test/browser/test-console-api.html",
    sourceId: null,
    lineText: "  let a, a;",
