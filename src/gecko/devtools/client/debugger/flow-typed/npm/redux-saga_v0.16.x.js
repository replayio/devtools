...
declare module "redux-saga" {
  ...
  declare type RunSagaOptions = {
    ...
    +logger?: (level: "info" | "warning" | "error", ...args: Array<any>) => void,
    +onError?: (error: Error) => void,
  };

  declare export var runSaga: {
    <R, Fn: () => Saga<R>>(options: RunSagaOptions, saga: Fn): Task<R>,
    <R, T1, Fn: (t1: T1) => Saga<R>>(options: RunSagaOptions, saga: Fn, t1: T1): Task<R>,
    ...
    <R, T1, T2, T3, T4, T5, Fn: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5) => Saga<R>>(
      options: RunSagaOptions,
      saga: Fn,
      t1: T1,
      t2: T2,
    ...
    <R, T1, T2, T3, T4, T5, T6, Fn: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6) => Saga<R>>(
      options: RunSagaOptions,
      saga: Fn,
      t1: T1,
      t2: T2,
  ...
  declare interface SagaMiddleware {
    ...
    run: {
      ...
      <R, T1, T2, Fn: (t1: T1, t2: T2) => Saga<R>>(saga: Fn, t1: T1, t2: T2): Task<R>,
      <R, T1, T2, T3, Fn: (t1: T1, t2: T2, t3: T3) => Saga<R>>(
        saga: Fn,
        t1: T1,
        t2: T2,
  ...
  declare export type TakeEffect<P: Pattern | void, C: Channel | void, M: true | void> = {
    +"@@redux-saga/IO": true,
    +TAKE: {
      +pattern: P,
      +channel: C,
  ...
  declare export type SpawnEffect<Ctx, Fn: Function, Args: $ReadOnlyArray<*>> = {
    +"@@redux-saga/IO": true,
    +SPAWN: {
      +context: Ctx,
      +fn: Fn,
  ...
  declare export type CancelEffect<T: Task<*> | "@@redux-saga/SELF_CANCELLATION"> = {
    +"@@redux-saga/IO": true,
    +CANCEL: T,
  };
  ...
  declare export type RaceEffect<R: { +[name: string]: Effect } | $ReadOnlyArray<Effect>> = {
    +"@@redux-saga/IO": true,
    +RACE: R,
  };
...
declare module "redux-saga/effects" {
  ...
  declare export var call: {
    ...
    <R, T1, T2, Fn: (t1: T1, t2: T2) => R>(fn: Fn, t1: T1, t2: T2): CallEffect<null, Fn, [T1, T2]>,
    ...
    <Ctx, R, T1, Fn: (t1: T1) => R>(cfn: [Ctx, Fn], t1: T1): CallEffect<Ctx, Fn, [T1]>,
  ...
  declare export var apply: {
    ...
    <Ctx, R, T1, Fn: (t1: T1) => R>(ctx: Ctx, fn: Fn, t1: T1): CallEffect<Ctx, Fn, [T1]>,
    <Ctx, R, T1, T2, Fn: (t1: T1, t2: T2) => R>(
      ctx: Ctx,
      fn: Fn,
      t1: T1,
  ...
  declare export var cps: {
    ...
    <R, T1, Fn: (t1: T1, cb: NodeCallback<R>) => void>(fn: Fn, t1: T1): CpsEffect<null, Fn, [T1]>,
    ...
    <R, T1, T2, T3, T4, Fn: (t1: T1, t2: T2, t3: T3, t4: T4, cb: NodeCallback<R>) => void>(
      fn: Fn,
      t1: T1,
      t2: T2,
      t3: T3,
    ...
    <
      ...
      T5,
      T6,
      Fn: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, cb: NodeCallback<R>) => void
    >(
      fn: Fn,
      t1: T1,
      t2: T2,
    ...
    // with context
    <Ctx, R, Fn: (cb: NodeCallback<R>) => void>(cfn: [Ctx, Fn]): CpsEffect<Ctx, Fn, []>,
    ...
    <Ctx, R, T1, T2, T3, Fn: (t1: T1, t2: T2, t3: T3, cb: NodeCallback<R>) => void>(
      cfn: [Ctx, Fn],
      t1: T1,
      t2: T2,
      t3: T3
    ): CpsEffect<Ctx, Fn, [T1, T2, T3]>,
    <Ctx, R, T1, T2, T3, T4, Fn: (t1: T1, t2: T2, t3: T3, t4: T4, cb: NodeCallback<R>) => void>(
      cfn: [Ctx, Fn],
      t1: T1,
      t2: T2,
      t3: T3,
  ...
  declare export var fork: {
    ...
    <R, T1, T2, Fn: (t1: T1, t2: T2) => R>(fn: Fn, t1: T1, t2: T2): ForkEffect<null, Fn, [T1, T2]>,
    <R, T1, T2, T3, Fn: (t1: T1, t2: T2, t3: T3) => R>(
      fn: Fn,
      t1: T1,
      t2: T2,
    ...
    <Ctx, R, T1, Fn: (t1: T1) => R>(cfn: [Ctx, Fn], t1: T1): ForkEffect<Ctx, Fn, [T1]>,
    <Ctx, R, T1, T2, Fn: (t1: T1, t2: T2) => R>(
      cfn: [Ctx, Fn],
      t1: T1,
      t2: T2
  ...
  declare export var spawn: {
    ...
    <R, T1, T2, Fn: (t1: T1, t2: T2) => R>(fn: Fn, t1: T1, t2: T2): SpawnEffect<null, Fn, [T1, T2]>,
    <R, T1, T2, T3, Fn: (t1: T1, t2: T2, t3: T3) => R>(
      fn: Fn,
      t1: T1,
      t2: T2,
    ...
    <Ctx, R, T1, Fn: (t1: T1) => R>(cfn: [Ctx, Fn], t1: T1): SpawnEffect<Ctx, Fn, [T1]>,
    <Ctx, R, T1, T2, Fn: (t1: T1, t2: T2) => R>(
      cfn: [Ctx, Fn],
      t1: T1,
      t2: T2
  ...
  declare export var select: {
    ...
    <S, R, T1, T2, T3, T4, T5, Fn: (state: S, t1: T1, t2: T2, t3: T3, t4: T4, t5: T5) => R>(
      fn: Fn,
      t1: T1,
      t2: T2,
      t3: T3,
  ...
  declare export var race: {
    <R: { +[name: string]: Effect } | $ReadOnlyArray<Effect>>(effects: R): RaceEffect<R>,
  };
