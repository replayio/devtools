...
export type GetOwnerAndCollaborators_recording_collaborators_edges_node =
  | GetOwnerAndCollaborators_recording_collaborators_edges_node_RecordingPendingEmailCollaborator
