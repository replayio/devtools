...
export type GetRecording_recording_collaborators_edges_node =
  | GetRecording_recording_collaborators_edges_node_RecordingPendingEmailCollaborator
  | GetRecording_recording_collaborators_edges_node_RecordingUserCollaborator;
