...
function HeaderTitle({
  ...
  return (
    <span
      className="input focus:ring-primaryAccent ml-2 focus:border-blue-500 text-2xl p-1 bg-transparent border-black whitespace-pre overflow-hidden overflow-ellipsis inter"
      role="textbox"
      spellCheck="false"
      contentEditable
      onBlur={onBlur}
