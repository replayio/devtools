...
/***/ (function(module, exports, __webpack_require__) {
  ...
  // EXTERNAL MODULE: C:/Projects/react/node_modules/nullthrows/nullthrows.js
  var nullthrows = __webpack_require__(56);
    ...
    case 'application/xhtml+xml':
      {
        ...
        installHook(window);
        window.logMessage("injectGlobalHook installed");
  ...
  __webpack_require__.d(__webpack_exports__, "q", function() { return /* binding */ getWrappedDisplayName; });
  ...
  __webpack_require__.d(__webpack_exports__, "w", function() { return /* binding */ utfDecodeString; });
  __webpack_require__.d(__webpack_exports__, "x", function() { return /* binding */ utfEncodeString; });
  ...
  __webpack_require__.d(__webpack_exports__, "s", function() { return /* binding */ saveComponentFilters; });
  ...
  __webpack_require__.d(__webpack_exports__, "v", function() { return /* binding */ shallowDiffers; });
  ...
  __webpack_require__.d(__webpack_exports__, "r", function() { return /* binding */ renamePathInObject; });
  ...
  const Yallist = __webpack_require__(61);
  ...
  var react_debug_tools = __webpack_require__(67);
  ...
  var shared_isArray = __webpack_require__(23);
  
  // EXTERNAL MODULE: ../react-devtools-timeline/src/constants.js
  var src_constants = __webpack_require__(32);
  ...
  function getInternalReactConstants(version) {
    ...
    function getDisplayNameForFiber(fiber) {
      ...
      switch (tag) {
        ...
        case ForwardRef:
          return Object(utils["q" /* getWrappedDisplayName */])(elementType, resolvedType, 'ForwardRef', 'Anonymous');
        ...
        case SimpleMemoComponent:
          ...
          return Object(utils["q" /* getWrappedDisplayName */])(elementType, resolvedType, 'Memo', 'Anonymous');
  ...
  function attach(hook, rendererID, renderer, global) {
    ...
    function getStringID(string) {
      ...
      const encodedString = Object(utils["x" /* utfEncodeString */])(string);
    ...
    function renamePath(type, id, hookID, oldPath, newPath) {
      ...
      if (fiber !== null) {
        ...
        switch (type) {
            ...
            switch (fiber.tag) {
              case ClassComponent:
                if (oldPath.length === 0) {// Simple context value (noop)
                  ...
                  Object(utils["r" /* renamePathInObject */])(instance.context, oldPath, newPath);
                }
          ...
          case 'state':
            Object(utils["r" /* renamePathInObject */])(instance.state, oldPath, newPath);
            instance.forceUpdate();
            break;
        }
      }
  ...
  try {
    ...
    __webpack_require__(62)(Yallist);
  } catch (er) {}
  ...
  function Q(a, b, d) {
    var c,
        ...
        l = null,
        k = null;
    if (null != b) for (c in void 0 !== b.ref && (k = b.ref), void 0 !== b.key && (l = "" + b.key), b) N.call(b, c) && !P.hasOwnProperty(c) && (e[c] = b[c]);
  ...
  function U(a, b, d, c, e) {
    var l = typeof a;
    if ("undefined" === l || "boolean" === l) a = null;
    var k = !1;
    if (null === a) k = !0;else switch (l) {
      case "string":
      case "number":
        k = !0;
        break;
    ...
    if (k) return k = a, e = e(k), a = "" === c ? "." + T(k, 0) : c, M(e) ? (d = "", null != a && (d = a.replace(S, "$&/") + "/"), U(e, b, d, "", function (a) {
      return a;
    })) : null != e && (R(e) && (e = ca(e, d + (!e.key || k && k.key === e.key ? "" : ("" + e.key).replace(S, "$&/") + "/") + a)), b.push(e)), 1;
    k = 0;
    c = "" === c ? "." : c + ":";
    if (M(a)) for (var g = 0; g < a.length; g++) {
      ...
      var f = c + T(l, g);
      k += U(l, b, d, f, e);
    } else if (f = ba(a), "function" === typeof f) for (a = f.call(a), g = 0; !(l = a.next()).done;) l = l.value, f = c + T(l, g++), k += U(l, b, d, f, e);else if ("object" === l) throw b = String(a), Error("Objects are not valid as a React child (found: " + ("[object Object]" === b ? "object with keys {" + Object.keys(a).join(", ") + "}" : b) + "). If you meant to render a collection of children, use an array instead.");
    return k;
  }
  ...
  exports.cloneElement = function (a, b, d) {
    ...
    if (null != b) {
      void 0 !== b.ref && (l = b.ref, k = O.current);
  ...
  exports.experimental_use = function (a) {
  ...
  function H(a, b, e) {
    for (var g = [], c = null, l = g, q = 0, t = [], v = 0; v < b.length; v++) {
      var u = b[v];
      var d = a;
      ...
      b: {
        var m = k,
            n = F(m, d, E);
        if (-1 !== n) d = n;else {
          for (var f = 0; f < d.length && 5 > f; f++) if (n = F(m, d, f), -1 !== n) {
            E = f;
            d = n;
            break b;
          }
      ...
      b: {
        ...
        if (void 0 !== n) for (f = 0; f < n.length && f < m.length; f++) if (n[f].source !== m[f].source) {
          f < m.length - 1 && G(m[f].functionName, u.primitive) && f++;
          f < m.length - 1 && G(m[f].functionName, u.primitive) && f++;
          m = f;
          break b;
        }
