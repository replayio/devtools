...
/***/ (function(module, exports, __webpack_require__) {
  ...
  function fillInPath(object, data, path, value) {
    ...
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__[/* setInObject */ "u"])(object, path, value);
  }
  ...
  /* harmony import */ var clipboard_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15);
  ...
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "E", function() { return __PERFORMANCE_PROFILE__; });
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return TREE_OPERATION_ADD; });
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "w", function() { return TREE_OPERATION_REMOVE; });
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "y", function() { return TREE_OPERATION_REORDER_CHILDREN; });
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "B", function() { return TREE_OPERATION_UPDATE_TREE_BASE_DURATION; });
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "A", function() { return TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS; });
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "x", function() { return TREE_OPERATION_REMOVE_ROOT; });
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "z", function() { return TREE_OPERATION_SET_SUBTREE_MODE; });
  ...
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return LOCAL_STORAGE_DEFAULT_TAB_KEY; });
  ...
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return SESSION_STORAGE_RELOAD_AND_PROFILE_KEY; });
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return LOCAL_STORAGE_SHOULD_BREAK_ON_CONSOLE_ERRORS; });
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return LOCAL_STORAGE_BROWSER_THEME; });
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return LOCAL_STORAGE_SHOULD_APPEND_COMPONENT_STACK_KEY; });
  ...
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C", function() { return UNSUPPORTED_VERSION_URL; });
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return REACT_DEVTOOLS_WORKPLACE_URL; });
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return THEME_STYLES; });
  ...
  var backend_console = __webpack_require__(39);
  ...
  __webpack_require__.d(__webpack_exports__, "r", function() { return /* binding */ getWrappedDisplayName; });
  __webpack_require__.d(__webpack_exports__, "k", function() { return /* binding */ getDisplayName; });
  __webpack_require__.d(__webpack_exports__, "x", function() { return /* binding */ utfDecodeString; });
  __webpack_require__.d(__webpack_exports__, "y", function() { return /* binding */ utfEncodeString; });
  ...
  __webpack_require__.d(__webpack_exports__, "v", function() { return /* binding */ setSavedComponentFilters; });
  ...
  __webpack_require__.d(__webpack_exports__, "t", function() { return /* binding */ separateDisplayNameAndHOCs; });
  __webpack_require__.d(__webpack_exports__, "w", function() { return /* binding */ shallowDiffers; });
  ...
  __webpack_require__.d(__webpack_exports__, "s", function() { return /* binding */ renamePathInObject; });
  __webpack_require__.d(__webpack_exports__, "u", function() { return /* binding */ setInObject; });
  ...
  // UNUSED EXPORTS: alphaSortKeys, getUID, printOperationsArray
  
  // EXTERNAL MODULE: C:/Projects/react/node_modules/lru-cache/index.js
  var lru_cache = __webpack_require__(42);
  var lru_cache_default = /*#__PURE__*/__webpack_require__.n(lru_cache);
  
  // EXTERNAL MODULE: C:/Projects/react/build/oss-experimental/react-is/index.js
  ...
  function printOperationsArray(operations) {
    ...
    while (i < operations.length) {
      ...
      switch (operation) {
        case constants["v" /* TREE_OPERATION_ADD */]:
          {
        ...
        case constants["w" /* TREE_OPERATION_REMOVE */]:
          {
        ...
        case constants["x" /* TREE_OPERATION_REMOVE_ROOT */]:
          {
            i += 1;
        ...
        case constants["z" /* TREE_OPERATION_SET_SUBTREE_MODE */]:
          {
            const id = operations[i + 1];
        ...
        case constants["y" /* TREE_OPERATION_REORDER_CHILDREN */]:
          {
            const id = operations[i + 1];
        ...
        case constants["B" /* TREE_OPERATION_UPDATE_TREE_BASE_DURATION */]:
        ...
        case constants["A" /* TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS */]:
          const id = operations[i + 1];
  ...
  /* harmony import */ var react_devtools_shared_src_constants_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
  /**
   * Copyright (c) Meta Platforms, Inc. and affiliates.
   *
   * This source code is licensed under the MIT license found in the
  ...
  /* harmony import */ var _renderer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(51);
  /* harmony import */ var _DevToolsFiberComponentStack__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(45);
  ...
  const Yallist = __webpack_require__(64);
  ...
  var react_debug_tools = __webpack_require__(68);
  ...
  var shared_hasOwnProperty = __webpack_require__(49);
  ...
  var src_constants = __webpack_require__(34);
  
  // EXTERNAL MODULE: ../react-devtools-shared/src/backend/DevToolsFiberComponentStack.js + 2 modules
  var DevToolsFiberComponentStack = __webpack_require__(45);
  ...
  function getInternalReactConstants(version) {
    ...
    function getDisplayNameForFiber(fiber) {
      ...
      switch (tag) {
        ...
        case ForwardRef:
          return Object(utils["r" /* getWrappedDisplayName */])(elementType, resolvedType, 'ForwardRef', 'Anonymous');
        ...
        case SimpleMemoComponent:
          ...
          return Object(utils["r" /* getWrappedDisplayName */])(elementType, resolvedType, 'Memo', 'Anonymous');
  ...
  function attach(hook, rendererID, renderer, global) {
    ...
    function updateComponentFilters(componentFilters) {
      ...
      hook.getFiberRoots(rendererID).forEach(root => {
        ...
        pushOperation(constants["x" /* TREE_OPERATION_REMOVE_ROOT */]);
    ...
    function recordPendingErrorsAndWarnings() {
      ...
      fibersWithChangedErrorOrWarningCounts.forEach(fiber => {
        ...
        if (fiberID === null) {// Don't send updates for Fibers that didn't mount due to e.g. Suspense or an error boundary.
          ...
          pushOperation(constants["A" /* TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS */]);
    ...
    function flushPendingEvents(root) {
      ...
      if (numUnmountIDs > 0) {
        ...
        operations[i++] = constants["w" /* TREE_OPERATION_REMOVE */]; // The first number is how many unmounted IDs we're gonna send.
    ...
    function getStringID(string) {
      ...
      const encodedString = Object(utils["y" /* utfEncodeString */])(string);
    ...
    function recordMount(fiber, parentFiber) {
      ...
      if (isRoot) {
        pushOperation(constants["v" /* TREE_OPERATION_ADD */]);
        pushOperation(id);
        ...
        if ((fiber.mode & StrictModeBits) !== 0 && (parentFiber.mode & StrictModeBits) === 0) {
          pushOperation(constants["z" /* TREE_OPERATION_SET_SUBTREE_MODE */]);
          pushOperation(id);
    ...
    function recordProfilingDurations(fiber) {
      ...
      if (isProfiling) {
        ...
        if (alternate == null || treeBaseDuration !== alternate.treeBaseDuration) {
          ...
          pushOperation(constants["B" /* TREE_OPERATION_UPDATE_TREE_BASE_DURATION */]);
          pushOperation(id);
    ...
    function recordResetChildren(fiber, childSet) {
      ...
      pushOperation(constants["y" /* TREE_OPERATION_REORDER_CHILDREN */]);
    ...
    function renamePath(type, id, hookID, oldPath, newPath) {
      ...
      if (fiber !== null) {
        ...
        switch (type) {
            ...
            switch (fiber.tag) {
              case ClassComponent:
                if (oldPath.length === 0) {// Simple context value (noop)
                  ...
                  Object(utils["s" /* renamePathInObject */])(instance.context, oldPath, newPath);
                }
          ...
          case 'state':
            Object(utils["s" /* renamePathInObject */])(instance.state, oldPath, newPath);
            instance.forceUpdate();
            break;
        }
      }
      ...
      if (fiber !== null) {
        ...
        switch (type) {
            ...
            switch (fiber.tag) {
              case ClassComponent:
                if (path.length === 0) {
                  ...
                  Object(utils["u" /* setInObject */])(instance.context, path, value);
                }
          ...
          case 'state':
            switch (fiber.tag) {
              case ClassComponent:
                Object(utils["u" /* setInObject */])(instance.state, path, value);
                instance.forceUpdate();
                break;
            }
  ...
  try {
    ...
    __webpack_require__(65)(Yallist);
  } catch (er) {}
