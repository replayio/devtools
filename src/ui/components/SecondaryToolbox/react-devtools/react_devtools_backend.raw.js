...
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return getWrappedDisplayName; });
  ...
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return utfEncodeString; });
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return printOperationsArray; });
  ...
  /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return renamePathInObject; });
  ...
  function getInternalReactConstants(version) {
    ...
    function getDisplayNameForFiber(fiber) {
      ...
      switch (tag) {
        ...
        case ForwardRef:
          return Object(utils["j" /* getWrappedDisplayName */])(elementType, resolvedType, 'ForwardRef', 'Anonymous');
        ...
        case SimpleMemoComponent:
          ...
          return Object(utils["j" /* getWrappedDisplayName */])(elementType, resolvedType, 'Memo', 'Anonymous');
  ...
  function attach(hook, rendererID, renderer, global) {
    ...
    function getStringID(string) {
      ...
      const encodedString = Object(utils["n" /* utfEncodeString */])(string);
    ...
    function renamePath(type, id, hookID, oldPath, newPath) {
      ...
      if (fiber !== null) {
        ...
        switch (type) {
            ...
            switch (fiber.tag) {
              case ClassComponent:
                if (oldPath.length === 0) {// Simple context value (noop)
                  ...
                  Object(utils["l" /* renamePathInObject */])(instance.context, oldPath, newPath);
                }
          ...
          case 'state':
            Object(utils["l" /* renamePathInObject */])(instance.state, oldPath, newPath);
            instance.forceUpdate();
            break;
        }
      }
  ...
  class agent_Agent extends events["a" /* default */] {
    constructor(bridge) {
      ...
      _defineProperty(this, "getBackendVersion", () => {
        const version = "4.25.0-9ff738f53";
      ...
      const _version = "4.25.0-9ff738f53";
  ...
  function attach(hook, rendererID, renderer, global) {
    ...
    function flushPendingEvents(rootID) {
      ...
      pendingStringTable.forEach((value, key) => {
        ...
        const encodedKey = Object(utils["n" /* utfEncodeString */])(key);
      ...
      if (constants["s" /* __DEBUG__ */]) {
        Object(utils["k" /* printOperationsArray */])(operations);
    ...
    function renamePath(type, id, hookID, oldPath, newPath) {
      ...
      if (internalInstance != null) {
        ...
        if (publicInstance != null) {
          switch (type) {
            case 'context':
              Object(utils["l" /* renamePathInObject */])(publicInstance.context, oldPath, newPath);
              forceUpdate(publicInstance);
              break;
            ...
            case 'state':
              Object(utils["l" /* renamePathInObject */])(publicInstance.state, oldPath, newPath);
              forceUpdate(publicInstance);
              break;
          }
        }
    ...
    function overrideValueAtPath(type, id, hookID, path, value) {
      ...
      if (internalInstance != null) {
        ...
        if (publicInstance != null) {
          switch (type) {
            case 'context':
              Object(utils["m" /* setInObject */])(publicInstance.context, path, value);
              forceUpdate(publicInstance);
              break;
            ...
            case 'state':
              Object(utils["m" /* setInObject */])(publicInstance.state, path, value);
              forceUpdate(publicInstance);
              break;
          }
        }
