...
function getIsSecondaryHighlighted(hoveredWidgetMarker, message) {
  if (!message?.frame || !hoveredWidgetMarker?.location) {
    return false;
  }
...
export default class Message extends React.Component {
  render() {
    ...
    const isPrimaryHighlighted = hoveredWidgetMarker?.point === message.executionPoint;
    const isSecondaryHighlighted = getIsSecondaryHighlighted(hoveredWidgetMarker, message);
