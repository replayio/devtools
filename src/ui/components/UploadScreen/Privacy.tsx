...
export function ToggleShowPrivacyButton({
  ...
  return (
    <button
      ...
      className="group flex w-full flex-row items-center justify-between rounded-lg bg-jellyfishBgcolorp-3 text-left font-normal"
    >
...
function PrivacyData({ icon, name, urls }: { icon: string; name: string; urls: string[] }) {
  return (
    <div className="space-y-3 rounded-lg bg-jellyfishBgcolorp-3">
...
export function Privacy() {
  ...
  return (
    <div className="relative flex h-full w-full overflow-hidden rounded-xl bg-jellyfishBgcolorp-5 shadow-xl">
