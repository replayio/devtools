...
function LoadingScreen({
  ...
  const phrases = [
    ...
    "Being careful not to disrupt the timeline...",
  ];
  const longWaitMessage =
    "<div><p>This is taking longer than expected.</p><p><a href='http://replay.io/discord' target='discord'>Report problems on Discord</a></p>";
