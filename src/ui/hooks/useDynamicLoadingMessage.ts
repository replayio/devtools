...
const longWaitMessage = "<div><p>This is taking longer than expected.</p><p><a href='http://replay.io/discord' target='discord'>Contact us on Discord</a></p>";

export function useDynamicLoadingMessage(isProcessed: boolean, fallbackMessage: string, stalledTimeout: number) {
