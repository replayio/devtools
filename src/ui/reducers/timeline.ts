...
export default function update(
  ...
  switch (action.type) {
    ...
    case "set_hovered_widget_marker": {
      return { ...state, hoveredWidgetMarker: action.marker };
    }
...
export const getHoveredWidgetMarker = (state: UIState) => state.timeline.hoveredWidgetMarker;
